...
define('_MI_TDMSPOT_CAT', ' Catégorie');
define('_MI_TDMSPOT_ITEM', ' Article');
define('_MI_TDMSPOT_PERMISSIONS', 'Permissions');
define('_MI_TDMSPOT_ABOUT', 'About');
define('_MI_TDMSPOT_PREF', 'Préférences');

// pref
define('_MI_TDMSPOT_NAMES', 'Index: Afficher le nom des pages ?');
...
define('_MI_TDMSPOT_PAGES', 'Catégorie: Limite par defaut du nombre d\'article');
...
//block
define('_MI_TDMSPOT_BLOCK_TITLE', 'Ordre alphabétique');
define('_MI_TDMSPOT_BLOCK_DATE', 'Date de publication');
define('_MI_TDMSPOT_BLOCK_HITS', 'Affichage');
define('_MI_TDMSPOT_BLOCK_COUNTS', 'Popularité');
define('_MI_TDMSPOT_BLOCK_COMMENT', 'Critiques');
define('_MI_TDMSPOT_BLOCK_RAND', 'Au hasard');
define('_MI_TDMSPOT_BLOCK_LIMIT', 'Limite');
define('_MI_TDMSPOT_BLOCK_TEXTE', 'Limite du texte');
define('_MI_TDMSPOT_BLOCK_CAT', 'Catégorie');
