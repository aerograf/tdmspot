...
//Adminmenu(6, _AM_TDMSPOT_MANAGE_ABOUT);
//} else {
//require_once XOOPS_ROOT_PATH.'/Frameworks/art/functions.admin.php';
//loadModuleAdminMenu (6, _AM_TDMSPOT_MANAGE_ABOUT);
//}

//menu
echo '<div class="CPbigTitle" style="background-image: url(../assets/images/decos/about.png); background-repeat: no-repeat; background-position: left; padding-left: 60px; padding-top:20px; padding-bottom:15px;"><h3><strong>' . _AM_TDMSPOT_MANAGE_ABOUT . '</strong></h3>';
echo '</div><br>';
